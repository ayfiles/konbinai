        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4 items-center sm:items-start">
            <Button
              ...
              size="lg"
              className="w-[70%] sm:w-auto rounded-pill bg-white/20 border border-white/30 ring-1 ring-white/40 shadow-xl backdrop-blur-frosted text-white font-label text-[15px] px-10 py-6 transition-all duration-300 hover:bg-white/10 hover:ring-white/60"
            >
